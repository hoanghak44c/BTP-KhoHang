...
{
    public class DeNghiNhapDieuChuyenTGDAO : SystemDAO
    {
        private static DeNghiNhapDieuChuyenTGDAO instance;
        private DeNghiNhapDieuChuyenTGDAO()
        {
            //CRUDTableName = Declare.TableNamespace.tbl_ChungTu_ChiTiet;
            //UseCaching = true;
        }

        public static DeNghiNhapDieuChuyenTGDAO Instance
        {
            get
            {
                if (instance == null) instance = new DeNghiNhapDieuChuyenTGDAO();
                return instance;
            }
        }
        ...
        {
            ExecInsertCommand(Declare.StoreProcedureNamespace.spChungTuDNNDCTGInsert, chungTuDeNghiNhanDieuChuyenInfor.IdChungTu,
                           chungTuDeNghiNhanDieuChuyenInfor.SoChungTu,
                           chungTuDeNghiNhanDieuChuyenInfor.IdKho,
                           chungTuDeNghiNhanDieuChuyenInfor.IdKhoDieuChuyen,
