...
{
    public partial class rpt_HoaDonGiaTriGiaTang : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_HoaDonGiaTriGiaTang(DateTime Ngay, string TenDonVi, string DiaChi, string TenNguoiMua, string MaSoThue,
