...
{
    public class frm_ChiTietMaVachnew : frmChungTuNhap_ChiTietHangHoaBase
    {
        private int Idkho;
        ...
        public frm_ChiTietMaVachnew(frmChiTiet_ChungTuNhapBase frm, ChungTuCTHanghoaBasePairInfo li, List<ChungTu_ChiTietHangHoaXTHInfo> liChiTiet)
            : base(frm,li)
        {
            this.liHangHoa = li;
            this.liChiTiet = liChiTiet;
        }
        public frm_ChiTietMaVachnew(ChungTuCTHanghoaBasePairInfo li, List<ChungTu_ChiTietHangHoaXTHInfo> liChiTiet,int idkho)
            : base(li)
        {
            this.liHangHoa = li;
            this.liChiTiet = liChiTiet;
