...
namespace QLBanHang.Modules.KhoHang.Bussiness
{
    ...
    public class NhapDieuChuyenBussiness : ChungTuNhapKhoBusinessBase<ChungTuNhapDieuChuyenInfo, ChungTu_ChiTietInfo, ChungTu_ChiTietHangHoaBaseInfo>
    {
        public NhapDieuChuyenBussiness()
        {
        ...
        public NhapDieuChuyenBussiness(ChungTuNhapDieuChuyenInfo chungTuNhanDieuChuyenInfor)
            : base(chungTuNhanDieuChuyenInfor)
        {
            //if (chungTuNhanDieuChuyenInfor.LoaiChungTu != Convert.ToInt32(TransactionType.NHAN_DIEU_CHUYEN))
            //{
        ...
        protected override void CreateBusinessProvider()
        {
            BusinessKhoProvider = NhapDieuChuyenKhoDataProvider.Instance;
        }
