...
namespace QLBanHang.Modules.KhoHang.Bussiness
{
    ...
    public class NhanDieuChuyenCungTTBussiness : ChungTuNhapKhoBusinessBase<ChungTuNhapDieuChuyenInfor, ChungTu_ChiTietInfo, ChungTu_ChiTietHangHoaBaseInfo>
    {
        public NhanDieuChuyenCungTTBussiness()
        {
            ChungTu = new ChungTuNhapDieuChuyenInfor
            {
                LoaiChungTu = Convert.ToInt32(TransactionType.NHAN_DIEU_CHUYEN),
        ...
        public NhanDieuChuyenCungTTBussiness(ChungTuNhapDieuChuyenInfor chungTuNhanDieuChuyenInfor)
            : base(chungTuNhanDieuChuyenInfor)
        {
            //if (chungTuNhanDieuChuyenInfor.LoaiChungTu != Convert.ToInt32(TransactionType.NHAN_DIEU_CHUYEN))
            //{
        ...
        protected override void CreateBusinessProvider()
        {
            BusinessKhoProvider = NhanDieuChuyenCungTTDataProvider.Instance;
        }
