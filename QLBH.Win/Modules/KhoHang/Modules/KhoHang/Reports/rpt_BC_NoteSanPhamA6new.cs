...
{
    public partial class rpt_BC_NoteSanPhamA6new : DevExpress.XtraReports.UI.XtraReport
    {
        private string ThongTin,NhaCC;
        private bool Check;
        public rpt_BC_NoteSanPhamA6new()
        {
            InitializeComponent();
        }
        public rpt_BC_NoteSanPhamA6new(string CauHinh, string NhaCC,bool check)
        {
            InitializeComponent();
