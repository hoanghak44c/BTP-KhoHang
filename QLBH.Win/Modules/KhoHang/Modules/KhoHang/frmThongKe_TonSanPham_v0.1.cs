...
{
    public partial class frmThongKe_TonSanPham_v01 : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmThongKe_TonSanPham_v01()
        {
            InitializeComponent();
            //grvThongKeHangTon.ColumnFilterChanged += new EventHandler(grvThongKeHangTon_ColumnFilterChanged);
        }

        private void frmThongKe_TonSanPham_v01_Load(object sender, EventArgs e)
        {
            try
            {
                ////----------------
        ...
        private void frmThongKe_TonSanPham_v01_Activated(object sender, EventArgs e)
        {
//            try
//            {
//                if (!isActivating)
...
//            }
        ...
        private void btnReload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                pageIndex = 0;
                pageTotal = KhoThongKeHangTonDataProvider.Instance.LoadDataThongKeHangTonKho2(0, bteSanpham.Text, bteKho.Text, String.Empty, fromDate, toDate, pageSize, Declare.UserId);
                list = KhoThongKeHangTonDataProvider.Instance.GetListThongKeHangTonKho3(
       ...
       // }
        ...
        //    {
        //        pageIndex = 0;
        //        pageTotal = KhoThongKeHangTonDataProvider.Instance.LoadDataThongKeHangTonKho2(0, grvThongKeHangTon.Columns["MaSanPham"].FilterInfo.Value.ToString(), bteKho.Text, String.Empty, fromDate, toDate, pageSize, Declare.UserId);
        //        list = KhoThongKeHangTonDataProvider.Instance.GetListThongKeHangTonKho3(
        //                                bteKho.Text, String.Empty, fromDate, toDate, pageIndex, pageSize, Declare.UserId);
        //        grcHangTon.DataSource = list;
        //    }
        ...
        void FetchPageIndexData(object pageIndex)
        {
            ...
            //Debug.Print("Thread " + Thread.CurrentThread.ManagedThreadId + ":" + pageIndex.ToString());

            List<KhoThongKeHangTonInfo> listTmp =
                KhoThongKeHangTonDataProvider.Instance.GetListThongKeHangTonKho3(
                    bteKho.Text, String.Empty, fromDate, toDate, Convert.ToInt32(pageIndex), pageSize, Declare.UserId);

            foreach (KhoThongKeHangTonInfo khoThongKeHangTonInfo in listTmp)
            {
                list.Add(khoThongKeHangTonInfo);    
            }
        }
        ...
        private void btnViewAll_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (pageIndex >= pageTotal)
                {
                    pageTotal = -1;
                    pageIndex = 0;
                    if (list== null) list = new List<KhoThongKeHangTonInfo>();
                    list.Clear();
                    grcHangTon.RefreshDataSource();
                }
                ...
                if (listLoadWorker == null) listLoadWorker = new List<Thread>(3);
        ...
        private void ChiTietTrungChuyen_Click(object sender, EventArgs e)
        {
            TonInfoBase sp = (KhoThongKeHangTonInfo)grvThongKeHangTon.GetFocusedRow();
            if (sp != null)
            {
