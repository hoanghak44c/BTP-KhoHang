...
{
    public class frm_ChiTietPhieuNhanDieuChuyen : frmChungTuNhap_ChiTietHangHoaBase
    {
        public string soCTG;
        ...
        public frm_ChiTietPhieuNhanDieuChuyen(frmChiTiet_ChungTuNhapBase frm, ChungTuCTHanghoaBasePairInfo li, List<ChungTu_ChiTietHangHoaBaseInfo> liChiTiet,int idChungTuChiTiet)
            : base(frm,li)
        {
            this.frm = frm;
            this.liHangHoa = li;
