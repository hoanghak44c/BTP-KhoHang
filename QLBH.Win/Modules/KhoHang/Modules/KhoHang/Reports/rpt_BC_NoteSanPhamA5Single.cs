...
{
    public partial class rpt_BC_NoteSanPhamA5Single : DevExpress.XtraReports.UI.XtraReport
    {
        private string ThongTin,NhaCC;
        private bool Check;
        public rpt_BC_NoteSanPhamA5Single()
        {
            InitializeComponent();
        }
        public rpt_BC_NoteSanPhamA5Single(string CauHinh, string NhaCC,bool check)
        {
            InitializeComponent();
