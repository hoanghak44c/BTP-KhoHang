...
{
    public class frm_ChiTietPhieuXuatDieuChuyen : frmChungTuNhap_ChiTietHangHoaBase
    {
        ...
        public frm_ChiTietPhieuXuatDieuChuyen(frmChiTiet_ChungTuNhapBase frm, ChungTuCTHanghoaBasePairInfo li, List<ChungTu_ChiTietHangHoaBaseInfo> liChiTiet)
            : base(frm,li)
        {
            this.frm = frm;
            this.liHangHoa = li;
        ...
        public frm_ChiTietPhieuXuatDieuChuyen(frmChiTiet_ChungTuNhapBase frm, ChungTuCTHanghoaBasePairInfo li, List<ChungTu_ChiTietHangHoaBaseInfo> liChiTiet, int IdKhoDi)
            : base(frm, li)
        {
            this.frm = frm;
            this.liHangHoa = li;
