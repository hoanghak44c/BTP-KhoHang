...
{
    public partial class rpt_BC_NoteSanPhamA75 : DevExpress.XtraReports.UI.XtraReport
    {
        private string ThongTin,NhaCC;
        private bool Check;
        public rpt_BC_NoteSanPhamA75()
        {
            InitializeComponent();
        }
        public rpt_BC_NoteSanPhamA75(string CauHinh, string NhaCC,bool check)
        {
            InitializeComponent();
            ...
            lblDonGia.Font = new Font("Myriad Pro",13, FontStyle.Bold);
            lblMaSP.Height = 17;
            lblGiaVAT.Height = 17;
        }
