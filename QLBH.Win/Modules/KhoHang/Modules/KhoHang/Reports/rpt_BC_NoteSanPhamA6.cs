...
{
    public partial class rpt_BC_NoteSanPhamA6 : DevExpress.XtraReports.UI.XtraReport
    {
        private string ThongTin,NhaCC;
        public rpt_BC_NoteSanPhamA6()
        {
            InitializeComponent();
        }
        public rpt_BC_NoteSanPhamA6(string CauHinh,string NhaCC)
        {
            InitializeComponent();
        ...
        {
            rpt_BC_NoteSanPhamA6Detail rpt = (rpt_BC_NoteSanPhamA6Detail)xrSubreport1.ReportSource;
