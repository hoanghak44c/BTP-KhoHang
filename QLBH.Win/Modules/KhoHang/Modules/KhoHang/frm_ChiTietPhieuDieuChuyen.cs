...
{
    public class frm_ChiTietPhieuDieuChuyen : frmChungTuNhap_ChiTietHangHoaBase
    {
        ...
        public frm_ChiTietPhieuDieuChuyen(frmChiTiet_ChungTuNhapBase frm, ChungTuCTHanghoaBasePairInfo li, List<ChungTu_ChiTietHangHoaBaseInfo> liChiTiet)
            : base(frm,li)
        {
            this.frm = frm;
            this.liHangHoa = li;
        ...
        protected override void Check()
        {
            ...
            if (liChiTiet.Count != null)
            {
                for (int i = 0; i < liChiTiet.Count; i++)
                {
                    ...
                    //soluong = soluong + liChiTiet[i].SoLuongNhap;
                }
            }
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frm_ChiTietPhieuDieuChuyen";
